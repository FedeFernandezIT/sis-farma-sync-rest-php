...
|
*/
$config['rest_valid_logins'] = array('demo' => 'demo');
...
|--------------------------------------------------------------------------
|
| Agregar las bases de datos correspondientes a los usuarios.
| debe corresponder al perfil en database.php
|
|	array()
|
*/
$config['rest_user_db'] = array('demo' => 'demo');
